...
(function (R, ftree) {
    ...
    describe("ftree", function () {
        ...
        describe("toArray", function () {
            it("should convert a tree to nested array representation", function () {
        ...
        describe("toSeq", function () {
            it("should convert a tree to a sequence representing the inorder traversal", function () {
                var arr = ftree.toSeq(ftree.tree(1, [
                    ftree.tree(2, [
                        ftree.tree(3, []),
                        ftree.tree(4, [])
                    ]),
