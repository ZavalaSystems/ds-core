    ...
    describe("common library", function () {
        ...
        describe("isInteger", function () {
            it("should accept integers", function () {
                expect(common.isInteger("100")).toEqual(true);
            });
            it("should reject decimals", function () {
                expect(common.isInteger("100.1")).toEqual(false);
            });
            it("should reject alphabet chars", function () {
                expect(common.isInteger("ab")).toEqual(false);
            });
        });
    });
}(
