module.exports = (function (_, R, bilby, common, lens, hypermedia, db, org, commissions) {
    "use strict";
    /*jslint unparam: true */
    var distributorRootTemplate = _.template("/distributor/${id}"),
        ...
        partialPredicates = [
            ...
            R.compose(R.gt(0), R.prop("length"), R.prop("firstName")),
            R.compose(isDefined, R.prop("lastName")),
            R.compose(R.gt(0), R.prop("length"), R.prop("lastName"))
        ],
        upgradePredicates = [
        ...
        sponsorChangePredicates = R.concat(isValidGetPredicates, [
            R.compose(common.isDefined, R.prop("sponsor")),
            R.compose(common.isNumberLike, R.prop("sponsor"))
        ]),
        sponsorChangePrecondition = R.allPredicates(sponsorChangePredicates),
        ...
        transformSponsorChangeInput = R.compose(transformGetInput, lens.transformToInt(["sponsor"])),
    ...
    return bilby.environment()
        ...
        .property("sponsorChangePrecondition", sponsorChangePrecondition)
        ...
        .property("transformSponsorChangeInput", transformSponsorChangeInput)
        .envAppend(db)
        .envAppend(org)
        .envAppend(commissions);
}(
    require("lodash"),
    require("ramda"),
    require("bilby"),
