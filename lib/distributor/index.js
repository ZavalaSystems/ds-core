    ...
    */
    ...
    var baseTemplate = _.template("/distributor/${id}"),
        ...
        partialPredicates = [
            ...
            R.compose(common.isInteger, R.prop("distributorID")),
        ...
        upgradePredicates = [
            ...
            R.compose(common.isInteger, R.prop("enrollerID")),
            R.compose(isDefined, R.prop("sponsorID")),
            R.compose(common.isInteger, R.prop("sponsorID")),
