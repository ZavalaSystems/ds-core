...
module.exports = (function (moment, bilby, R, q, m, rankList, fortuna, db) {
    ...
    var requirements = {
        ...
        mapCommObj = mapCurrencyObj(["volume", "commissions"]),
        ...
        commissionsVolumes = function (r) {
            return {
                personal: mapCommObj(fortuna.personalDetails(r)),
                team: mapCommObj(fortuna.teamDetails(r)),
                sales: mapCommObj(fortuna.salesDetails(r)),
                gen1: mapCommObj(fortuna.gen1Details(r)),
                gen2: mapCommObj(fortuna.gen2Details(r)),
                gen3: mapCommObj(fortuna.gen3Details(r)),
                rank: fortuna.paidAs(r)
            };
        },
