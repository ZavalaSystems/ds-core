...
module.exports = (function (moment, bilby, R, q, m, rankList, fortuna, db) {
    ...
    var requirements = {
        ...
        commissionsVolumes = function (r) {
            return {
                ...
                team: mapCommissionDetails(fortuna.teamDetails(r)),
        ...
        couchQueryString = R.curry(function (id, bp) {
            return encodeURIComponent("key=[" + id + ", " + bp + "]");
        }),
        ...
        sortMostRecent = R.compose(R.reverse, R.sortBy(R.compose(R.prop("computed"), R.prop("value")))),
        commissionData = R.compose(R.omit(["computed", "_rev", "_id", "id", "bp"]), R.prop("value"));
    ...
    return bilby.environment()
        ...
        .property("couchQueryString", couchQueryString)
