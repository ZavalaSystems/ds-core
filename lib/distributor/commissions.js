...
module.exports = (function (moment, bilby, R, q, m, rankList, fortuna, db) {
    ...
    var requirements = {
        ...
        rawCommissionsVolumes = function (r) {
            var teamDetails = fortuna.teamDetails(r),
                lev1Details = fortuna.lev1Details(r);
            return {
                personal: fortuna.personalDetails(r),
                // Add presentation rule
                team: teamDetails,
                lev1: lev1Details,
                sales: fortuna.salesDetails(r),
                gen1: fortuna.gen1Details(r),
                gen2: fortuna.gen2Details(r),
                gen3: fortuna.gen3Details(r),
                paidAs: fortuna.paidAs(r),
                total: mkCurrency(fortuna.total(r))
            };
        },
        commissionsVolumes = function (r) {
            var raw = rawCommissionsVolumes(r);
            return R.mapObj(function (field) {
                if (!bilby.isNumber(field)) {
    ...
    return bilby.environment()
        ...
        .property("rawCommissionsVolumes", rawCommissionsVolumes)
