module.exports = (function (fs, path, R, bilby, common, cypher) {
    ...
    var readFileSync = R.rPartial(fs.readFileSync, {encoding: "utf8"}),
        ...
        org = cypher.cypherToObj(readFileSync(path.join(__dirname, "match-org.cql"))),
        computePv = cypher.cypherToObj(readFileSync(path.join(__dirname, "compute-pv.cql"))),
