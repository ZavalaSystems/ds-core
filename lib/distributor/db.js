module.exports = (function (fs, path, R, bilby, common, cypher) {
    ...
    var readFileSync = R.rPartial(fs.readFileSync, {encoding: "utf8"}),
        ...
        changeSponsor = cypher.cypherToObj(readFileSync(path.join(__dirname, "change-sponsor.cql"))),
        changeRank = cypher.cypherToObj(readFileSync(path.join(__dirname, "change-rank.cql"))),
    ...
    return bilby.environment()
        ...
        .property("changeSponsor", changeSponsor)
        .property("changeRank", changeRank);
}(
    require("fs"),
    require("path"),
    require("ramda"),
