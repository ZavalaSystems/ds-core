...
(function (R, d) {
    ...
    describe("distributor core library", function () {
        describe("input precondition tests", function () {
            ...
            describe("upgradePredicates", function () {
                /*  This is here to help debug which function was returning false in isValidUpgrade,
                    there was no reason to remove it */
                it("should be applicable to a correct object as a sequence of all true", function () {
                    var results = R.ap(d.upgradePredicates,
                        [{enrollerID: 1, sponsorID: 1, enrollDate: "10/1/2015", rank: "Ambassador"}]);
            ...
            describe("isValidUpgrade", function () {
                it("should return true when all fields are present and valid", function () {
                    ...
                    expect(d.isValidUpgrade({enrollerID: 1, sponsorID: 1, enrollDate: "10/1/2015", rank: "Ambassador"}))
                        .toBe(true);
                });
                ...
                it("should return false when the date is invalid", function () {
                    expect(d.isValidUpgrade({enrollerID: 1, sponsorID: 1, enrollDate: "Banana", rank: "Ambassador"}))
                        .toBe(false);
                });
        ...
        describe("transformDateToOffset", function () {
            it("should transform nested dates", function () {
                var date = new Date();
                expect(d.transformDateToOffset({
                    firstName: "Ryan",
                    lastName: "Zeigler",
