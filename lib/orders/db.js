module.exports = (function (path, fs, bilby, R, common, cypher) {
    ...
    var readFile = R.rPartial(fs.readFileSync, {encoding: "utf8"}),
        ...
        updateLineItem = cypher.cypherToObj(readFile(path.join(__dirname, "update-d+lineitem.cql"))),
        reassignOrder = cypher.cypherToObj(readFile(path.join(__dirname, "reassign-d+order.cql"))),
    ...
    return bilby.environment()
        ...
        .property("updateOrder", updateOrder)
        .property("updateLineItem", updateLineItem)
        ...
        .property("reassignOrder", reassignOrder)
